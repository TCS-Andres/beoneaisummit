    ...
    groups: [
      {
        ...
        size: "lg",
        people: [
          { name: "Britney Mapang", photo: "/pitch/britney-mapang-v3.webp" },
          { name: "Marco Mani", photo: "/pitch/marco-mani-v3.webp" },
          { name: "Martin Rasmussen", photo: "/pitch/martin-rasmussen-v3.webp" },
          { name: "Jhanille Smith", photo: "/pitch/jhanille-smith-v3.webp" },
        ],
      },
      {
        label: "Team MEALO",
        size: "lg",
        people: [{ name: "Milosz Mencel", photo: "/pitch/milosz-mencel-v3.webp" }],
      },
    ],
