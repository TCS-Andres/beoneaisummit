  ...
  return (
    <section id="top" className="relative overflow-hidden pt-16">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(180deg, rgba(5, 7, 15, 0.3) 0%, rgba(5, 7, 15, 0.1) 45%, rgba(5, 7, 15, 0.82) 100%), radial-gradient(52rem 30rem at 50% 0%, rgba(124, 92, 255, 0.18), transparent 60%)",
        }}
      />

      <div className="relative mx-auto max-w-5xl px-4 pb-20 pt-16 text-center sm:px-6 sm:pt-24">
        <div data-reveal>
          <h1 className="mx-auto max-w-4xl text-5xl font-bold leading-[1.05] [text-shadow:0_2px_24px_rgba(5,7,15,0.85)] sm:text-7xl">
            AI for Small Business{" "}
            <span className="bg-gradient-to-r from-glow to-[#6ec1ff] bg-clip-text text-transparent [text-shadow:none]">
              Summit 2026
            </span>
          </h1>

          <p className="mx-auto mt-7 max-w-3xl text-2xl font-semibold text-white [text-shadow:0_2px_18px_rgba(5,7,15,0.9)] sm:text-3xl">
            {SUMMIT.theme}
          </p>
          <p className="mx-auto mt-4 max-w-2xl text-lg font-medium text-mist [text-shadow:0_1px_14px_rgba(5,7,15,0.9)] sm:text-xl">
